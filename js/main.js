      ...
      <div class="glass-card rounded-2xl overflow-hidden border border-slate-800 flex flex-col justify-between group relative">
        <div class="relative h-56 w-full overflow-hidden bg-slate-900">
          ...
          <div class="absolute inset-0 bg-slate-950/60 backdrop-blur-xs opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center gap-3">
            ...
            <a href="${project.githubUrl || '#'}" target="_blank" rel="noreferrer" class="p-2.5 rounded-xl bg-slate-900/90 hover:bg-slate-800 text-slate-200 border border-slate-700 hover:border-slate-500 transition-transform hover:scale-105 flex items-center justify-center" title="GitHub Repository">
        ...
        <div class="p-6 flex-1 flex flex-col justify-between">
          ...
          <div>
            ...
            <div class="pt-4 border-t border-slate-800/80 flex items-center justify-between">
              ...
              <a href="${project.githubUrl || '#'}" target="_blank" rel="noreferrer" class="text-xs font-mono text-slate-400 hover:text-slate-200 inline-flex items-center space-x-1.5">
...
function renderProjectModalContent(activeTab = 'demo') {
  ...
  modalContainer.innerHTML = `
    <div class="px-6 py-4 bg-slate-900 border-b border-slate-800 flex items-center justify-between shrink-0">
      ...
      <div class="flex items-center space-x-3">
        <a href="${project.githubUrl || '#'}" target="_blank" rel="noreferrer" class="p-1.5 rounded-lg bg-slate-800 text-slate-300 hover:text-white hover:bg-slate-700 transition-colors flex items-center justify-center" title="GitHub Repo">
          <i class="fa-brands fa-github text-base"></i>
        </a>
